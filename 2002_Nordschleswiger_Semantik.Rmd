---
title: "2002_august_19_Der_Nordschleswiger"
...
### Her indlæses pdf af Der Nordschleswiger fra Der Nordschleswiger E-archiv. Den er fra den 19 august 2002. tibble(readtext)) gør at R-studio kan læse pdf filen og dermed avisen fra Der Nordschleswiger.
```{r}
testpdf <- tibble(readtext("PDF_Nordschleswiger_2002/*.pdf"))
```
# Textmining_Unnest
...
```{r}
ggsave("cloud_2002_august_19_Der_Nordschleswiger.png", width = 6, height = 4, dpi = 300)
```
...
# Gem Graf
```{r}
ggsave("Polarität_2002_august_19_Der_Nordschleswiger.png", width = 6, height = 4, dpi = 300)
```
...
# Gem graf
```{r}
ggsave("negativ_2002_august_19_Der_Nordschleswiger.png", width = 6, height = 4, dpi = 300)
```
...
# Gem graf
```{r}
ggsave("positive_2002_august_19_Der_Nordschleswiger.png", width = 6, height = 4, dpi = 300)
```
