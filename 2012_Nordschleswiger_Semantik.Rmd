---
title: "2012_august_20_Der_Nordschleswiger"
...
### Her indlæses en pdf af Der Nordschleswiger fra Der Nordschleswiger E-archiv. Den er fra den 20 august 2012. tibble(readtext)) gør at R-studio kan læse pdf filen og dermed avisen fra Der Nordschleswiger.
```{r}
testpdf <- tibble(readtext("PDF_Nordschleswiger_2012/*.pdf"))
```
# Textmining_Unnest
...
```{r}
ggsave("cloud_2012_august_20_Der_Nordschleswiger.png", width = 6, height = 4, dpi = 300)
```
...
# Gem Graf
```{r}
ggsave("polarität_2012_august_20_Der_Nordschleswiger.png", width = 6, height = 4, dpi = 300)
```
...
# Gem Graf
```{r}
ggsave("negativ_2012_august_20_Der_Nordschleswiger.png", width = 6, height = 4, dpi = 300)
```
...
# Gem Graf
```{r}
ggsave("positiv_2012_august_20_Der_Nordschleswiger.png", width = 6, height = 4, dpi = 300)
```
