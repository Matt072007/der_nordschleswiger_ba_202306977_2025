---
title: "1992_august_29_Der_Nordschleswiger"
...
### Her indlæses pdf af Der Nordschleswiger fra Der Nordschleswiger E-archiv. Den er fra den 29 august 1992. tibble(readtext)) gør at R-studio kan læse pdf filen og dermed avisen fra Der Nordschleswiger.
```{r}
testpdf <- tibble(readtext("PDF_Nordschleswiger_1992/*.pdf"))
```
# Textmining_Unnest
...
```{r}
ggsave("cloud_1992_august_29_Der_Nordschleswiger.png", width = 6, height = 4, dpi = 300)
```
...
# Gem Graf
```{r}
ggsave("polarität_1992_august_29_Der_Nordschleswiger.png", width = 6, height = 4, dpi = 300)
```
...
# Gem Graf
```{r}
ggsave("negativ_1992_august_29_Der_Nordschleswiger.png", width = 6, height = 4, dpi = 300)
```
...
# Gem Graf
```{r}
ggsave("positiv_1992_august_29_Der_Nordschleswiger.png", width = 6, height = 4, dpi = 300)
```
