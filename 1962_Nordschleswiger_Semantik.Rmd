---
title: "1962_august_20_Der_Nordschleswiger"
...
### Her indlæses en pdf af Der Nordschleswiger fra Der Nordschleswiger E-archiv. Den er fra den 20 august 1962. tibble(readtext)) gør at R-studio kan læse pdf filen og dermed avisen fra Der Nordschleswiger.
```{r}
testpdf <- tibble(readtext("PDF_Nordschleswiger_1962/*.pdf"))
```
# Textmining_Unnest
...
```{r}
ggsave("cloud_1962_august_20_Der_Nordschleswiger.png", width = 6, height = 4, dpi = 300)
```
...
### Her indlæses data fra den semantiske fil SentiWS_V2.0_Negative.txt via funktionen read.table.

```{r}
negativ <- read.table("C:/Users/Asus PC/Desktop/Semantisk_Analyse_Nordschleswiger/SentiWS_v2.0/SentiWS_v2.0_Negative.txt" , fill = TRUE)
```
...
### Her indlæses data fra den semantiske fil SentiWS_V2.0_Positive.txt via funktionen read.table.

```{r}
positiv <- read.table("C:/Users/Asus PC/Desktop/Semantisk_Analyse_Nordschleswiger/SentiWS_v2.0/SentiWS_v2.0_Positive.txt", fill = TRUE)
```
...
# Gem Graf
```{r}
ggsave("polarität_1962_august_20_Der_Nordschleswiger.png", width = 6, height = 4, dpi = 300)
```
...
# Gem Graf
```{r}
ggsave("negativ_1962_august_20_Der_Nordschleswiger.png", width = 6, height = 4, dpi = 300)
```
...
# Gem Graf
```{r}
ggsave("positiv_1962_august_20_Der_Nordschleswiger.png", width = 6, height = 4, dpi = 300)
```
